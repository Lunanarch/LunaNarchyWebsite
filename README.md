> Tu es autorisé·e à réutiliser mon site internet pour ton usage personnel. Néanmoins, le contenu de celui ne t'appartient pas (images, textes, etc...), merci donc de ne pas le publier sans modifications.
